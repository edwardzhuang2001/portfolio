    ...
    <section id="about">
      ...
      <div className="about-container">
        ...
        <div className="about-text">
          ...
          <p className="about-item">
            In my free time, I enjoy exploring all kinds of music, travelling the world, reading fiction (and occasionally non-fiction), playing video games, and staying active through a mix of bouldering, running, and various recreational sports.
          </p>
        </div>
      </div>
    </section>
